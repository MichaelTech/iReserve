...
- (void)addRecord: (NSArray*)record {
    ...
    for(uint i=0; i<record.count; i++){
        ...
        if(self->numRows == 0){
			...
			col1.backgroundColor = [UIColor colorWithWhite:0.961 alpha:0.1];
        }
        ...
        if ([[record objectAtIndex:i] isEqualToString:TextHave])
        {
            col1.textColor = [UIColor whiteColor];
            col1.backgroundColor = [UIColor colorWithRed:10/155 green:255/255 blue:0/255 alpha:.3];
        }
        else
        {
